// Ce fichier permet de simuler une liste initiale de pokemons
// IL sagit d'une liste de 12 pokemons qui ont des propriétés qu'on a précédemment définies dans notre modèle "pokemon.ts"

import { Pokemon } from './pokemon';

// Ce fichier exporte dans une constante POKEMONS la liste suivante que nous avons définie
